...
def _apply_caption_form(fields: Dict[str, str], *, caption: Optional[str]=None, parse_mode: Optional[str]=None, caption_entities: Optional[EntitiesInput]=None) -> None:
    """Telegram Bot API method ``_apply_caption_form`` (T1-T5).
...
without changing request construction, return parsing, or error behavior."""
    ...
    if serialized is not None:
        fields['caption_entities'] = self._json_field(serialized)
