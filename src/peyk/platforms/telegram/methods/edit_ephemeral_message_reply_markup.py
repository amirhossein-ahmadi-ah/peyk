...
async def edit_ephemeral_message_reply_markup(self, chat_id: Union[int, str], receiver_user_id: Optional[int]=None, ephemeral_message_id: Optional[int]=None, *, reply_markup: Optional[InlineKeyboardMarkup]=None) -> bool:
...
Returns:
    ...
    result = await self._call('editEphemeralMessageReplyMarkup', json_body=payload)
