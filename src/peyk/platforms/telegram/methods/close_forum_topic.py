...
async def close_forum_topic(self, chat_id: ChatId, message_thread_id: int) -> bool:
...
Returns:
    ...
    return bool(await self._call('closeForumTopic', json_body={'chat_id': chat_id, 'message_thread_id': message_thread_id}))
