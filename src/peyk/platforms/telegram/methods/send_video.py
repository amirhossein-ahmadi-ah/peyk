...
Returns:
    ...
    if start_timestamp is not None:
        extra['start_timestamp'] = start_timestamp
    ...
    if cover is not None:
        files['cover'] = cover
    return await self._send_file_message('sendVideo', 'video', chat_id, video, caption=caption, parse_mode=parse_mode, caption_entities=caption_entities, message_thread_id=message_thread_id, disable_notification=disable_notification, protect_content=protect_content, reply_parameters=reply_parameters, reply_markup=reply_markup, extra_json=extra, extra_files=files or None, default_filename='video.mp4')
