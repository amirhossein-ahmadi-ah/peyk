...
Attributes:
    ...
    @classmethod
    def from_dict(cls, data: Optional[dict]) -> Optional['ForumTopic']:
...
Returns:
    Result produced by the operation."""
        "Executes the from_dict operation.\n        \n        Args:\n            data: Value of the declared parameter type.\n        \n        \n        Returns:\n            The operation result (``Optional['ForumTopic']``).\n        "
        if data is None:
            return None
        return cls(message_thread_id=data['message_thread_id'], name=data.get('name', ''), icon_color=data.get('icon_color'), icon_custom_emoji_id=data.get('icon_custom_emoji_id'), is_name_implicit=data.get('is_name_implicit'))
