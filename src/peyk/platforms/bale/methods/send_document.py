...
async def send_document(self, chat_id: Union[int, str], document: MediaInput, *, caption: Optional[str]=None, reply_to_message_id: Optional[int]=None, reply_markup: Optional[Mapping[str, object]]=None) -> Message:
...
Returns:
    ...
    'Implement Bale client method ``send_document``.\n\nArgs:\n    Uses the parameter values documented by the method signature.\n\nReturns:\n    The value returned by the Bale API after parsing.\n\nRaises:\n    BaleAPIError: If the Bale API rejects the request.\n\nExample:\n    ``await client.send_document(... )``'
    result = await self._send_media('sendDocument', 'document', chat_id, document, caption, reply_to_message_id=reply_to_message_id, reply_markup=reply_markup, default_filename='document')
