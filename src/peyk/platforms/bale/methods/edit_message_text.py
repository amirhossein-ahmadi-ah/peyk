...
async def edit_message_text(self, chat_id: Union[int, str], message_id: int, text: str, *, reply_markup: Optional[Mapping[str, object]]=None) -> Message:
