...
async def edit_message_caption(self, chat_id: Union[int, str], message_id: int, *, caption: Optional[str]=None, reply_markup: Optional[Mapping[str, object]]=None) -> Message:
