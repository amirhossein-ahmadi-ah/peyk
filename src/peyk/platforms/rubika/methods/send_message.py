...
async def send_message(self, chat_id: str, text: str, *, metadata: Optional[Union[Metadata, Dict[str, object]]]=None, chat_keypad: Optional[Union[Keypad, Dict[str, object]]]=None, inline_keypad: Optional[Union[Keypad, Dict[str, object]]]=None, chat_keypad_type: Optional[str]=None, reply_to_message_id: Optional[str]=None, disable_notification: Optional[bool]=None) -> Message:
...
Returns:
    ...
    data = await self._call('sendMessage', json_body=payload)
    return self._parse_message_id_response(data, 'sendMessage')
