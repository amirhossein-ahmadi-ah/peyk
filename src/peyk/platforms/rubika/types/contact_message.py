...
class ContactMessage:
    ...
    @classmethod
    def from_dict(cls, data: Optional[dict]) -> Optional['ContactMessage']:
...
Returns:
    Result produced by the Rubika operation."""
        "Executes the from_dict operation.\n        \n        Args:\n            data: Value of the declared parameter type.\n        \n        \n        Returns:\n            The operation result (``Optional['ContactMessage']``).\n        "
        if data is None:
            return None
        return cls(phone_number=data.get('phone_number'), first_name=data.get('first_name'), last_name=data.get('last_name'))
